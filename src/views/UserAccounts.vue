<template>
  <div>
     ...
     <main class="pb-4 md:ml-64 h-screen pt-20">
                      ...
                      >
                        ...
                        <div class="py-1">
                          <button
                            ...
                            class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white w-full text-left"
                          >
                            Delete
                          </button>
                        </div>
